...
const OWNER_SECTIONS = [
  {
    ...
    steps: [
      ...
      "収録締切と公開予定は日付・時刻まで設定し、必要な期日は「期日を追加」から増やします。",
  ...
  },
  {
    ...
    steps: [
      ...
      "質問者が回答を確認して「解決済みにする」を押すと「解決済み」へ移ります。",
  ...
  },
  {
    ...
    steps: [
      ...
      "章別収録、リテイク、確認日などの期日は、名前・種類・日付・任意の時刻・状態・共有メモを付けて追加します。",
...
const ACTOR_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "回答で解決したら「解決済みにする」を押します。まだ不明点が残る場合は、状況が分かる内容で追加の質問を登録します。"
    ]
  },
  {
    id: "actor-schedule",
