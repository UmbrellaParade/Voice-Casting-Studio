...
const ACTOR_STEPS = [
  ...
  ["3", "録音を提出", "担当フォルダーへ録音を置き、共有URLと収録済みを保存します。"],
...
const ACTOR_SECTIONS = [
  ...
  },
  {
    id: "actor-submit",
    title: "録音を提出する",
    summary: "録音ファイルはGoogle Driveへ置き、台本には共有URLを登録します。",
    icon: FileAudio,
    target: "script",
    steps: [
      "「共有リンク」またはキャラクター画面から、自分の収録フォルダーを開きます。",
      "録音ファイルをGoogle Driveへアップロードし、そのファイルの共有URLをコピーします。",
      "担当セリフの「Google Drive録音URL」へ貼り付け、「収録済み」にチェックして保存します。",
      "補足がある場合は提出メモへ書きます。リテイク後の保存は「再提出済み」として共有されます。"
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "「リテイク」になった場合は確認メモを読み、同じセリフへ新しい録音URLを保存します。",
